...
class Config:
    ...
    SEDA_CSV = RAW_DATA_DIR / "seda_geodist_annualsub_cs_6.0.csv"  # SEDA district-level data
    SHAPEFILE = RAW_DATA_DIR / "schooldistricttl25_tidy.shp"  # school districts
    
    # Output files
    IMAGES_DIR = DATA_DIR / "images" / "streetview_images"
    METADATA_CSV = PROCESSED_DATA_DIR / "street_view_metadata.csv"
    VALID_POINTS_CSV = PROCESSED_DATA_DIR / "valid_points.csv"
    IMAGE_DOWNLOAD_PROGRESS_CSV = PROCESSED_DATA_DIR / "image_download_progress.csv"
    DISTRICT_COVERAGE_CSV = PROCESSED_DATA_DIR / "district_image_coverage.csv"
    COVERAGE_REPORT_JSON = PROCESSED_DATA_DIR / "district_image_coverage.json"
    DOWNLOADED_IMAGES_CSV = PROCESSED_DATA_DIR / "downloaded_images.csv"
